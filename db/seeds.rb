...
# User.create!(name: 'legomushroom2', password: '123' )
# User.create!(name: 'legomushroom3', password: '123', password_confirmation: '123' )

# User.delete_all

# User.create!(name: 'legomushroom4', password: '123' )
...
#   title: 'Poyo Hermano',
#   locale: 'es',
#   description: 'Buenos dias, amico!',
#   image_url: 'crystal.jpg',
#   price: 10.00
# )

# Product.create!(
#   title: 'Los gatos blancos',
#   locale: 'es',
#   description: 'Capito, capito!',
#   image_url: 'crystal.jpg',
#   price: 15.00
# )
